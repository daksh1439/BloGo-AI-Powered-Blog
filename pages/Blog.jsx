...
import { blog_data, comments_data, assets } from '../assets/QuickBlog-Assets/assets'
...
const Blog = () => {
  ...
  const fetchBlogData = async () => {
    const blogItem = blog_data.find(item => String(item._id) === String(id));
    setData(blogItem || null);
  }
  ...
  return data ? (
    <div className='relative'>
      <img src={gradient} alt="background" className='fixed inset-0 w-full h-full object-cover -z-10 opacity-50'></img>
      <Navbar/>
     ...
     {/*share buttons */}
        <div className='my-24 max-w-3xl mx-auto'>
          <p classsName='font-semibold my-4'>Share this article on social media</p>
